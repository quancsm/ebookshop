        ...
        <div id="s-footer">
            <div class="col-md-12 col-sm-12">
                <div class="footer-text">
                    <p><i class="fas fa-copyright"></i> BlogITCode. <br>
                        website: blogitcode.com</p>
                </div>
                <div id="social-icon">
                    <span><a href="https://www.facebook.com/blogitcode" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a></span>
                    <span><a href="#" title="Github" target="_blank"><i class="fab fa-github"></i></a></span>
                    <span><a href="#" title="Instagram" target="_blank"><i class="fab fa-instagram"></i></a></span>
                </div>
            </div>
        </div>
    </div>
